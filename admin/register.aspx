                                    ...
                                    <div class="card-body p-4 p-md-5">
                                        <asp:MultiView ID="mvAuth" runat="server" ActiveViewIndex="0">
                                            ...
                                            <asp:View ID="vRegister" runat="server">
                                                <h4 class="fw-bold mb-4">Create New Admin Account</h4>

                                                <asp:Panel ID="pnlRegisterError" runat="server" CssClass="alert alert-danger" Visible="false">
                                                ...
                                                <div class="row">
                                                    <div class=" mb-3">
                                                        <asp:Label ID="lblUserName" runat="server" CssClass="form-label">User Name</asp:Label>
                                                ...
                                                <div class="mb-3">
                                                    <asp:Label ID="lblRegEmail" runat="server" CssClass="form-label">Email Address</asp:Label>
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                                        <asp:TextBox ID="txtRegEmail" runat="server" CssClass="form-control" placeholder="Enter your email" TextMode="Email"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    <asp:Label ID="lblRegPassword" runat="server" CssClass="form-label">Password</asp:Label>
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                                        <asp:TextBox ID="txtRegPassword" runat="server" CssClass="form-control" placeholder="Enter password" TextMode="Password"></asp:TextBox>
                                                    </div>
